...
export default function AjaxUtil() {}
 ...
 */
AjaxUtil.ajaxRequest = function(options)
{
 ...
 * @return  {Promise}		Promise.
 */
AjaxUtil.loadScript = function(url) {
 ...
 * @return  {*}				Value.
 */
AjaxUtil.__getOption = function(options, key, defaultValue)
{
